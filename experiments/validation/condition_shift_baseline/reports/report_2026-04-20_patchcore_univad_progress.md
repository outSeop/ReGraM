...
- image identity reproduction:
  - source: [identity_reproduction_check.json](identity_reproduction_check.json)
  - result: `575 / 575` compared, `mismatch_count = 0`
- PatchCore score identity reproduction:
  - source: [breakfast_box.json](patchcore_identity_repro/breakfast_box.json)
  - `mean_abs_diff = 0.0`
  - `max_abs_diff = 0.0`
...
- source: [patchcore_clean_eval_breakfast_box.json](patchcore_clean_eval_breakfast_box.json)
...
- source: [breakfast_box_multi.json](patchcore_manifest_shift/breakfast_box_multi.json)
...
- overview: [all_augmentations_breakfast_box_000.png](sample_panels/all_augmentations_breakfast_box_000.png)
- per-shift panels:
  - [brightness](sample_panels/brightness_breakfast_box_000.png)
  - [gaussian_blur](sample_panels/gaussian_blur_breakfast_box_000.png)
  - [motion_blur](sample_panels/motion_blur_breakfast_box_000.png)
  - [gaussian_noise](sample_panels/gaussian_noise_breakfast_box_000.png)
  - [compression](sample_panels/compression_breakfast_box_000.png)
  - [low_resolution](sample_panels/low_resolution_breakfast_box_000.png)
  - [position_shift](sample_panels/position_shift_breakfast_box_000.png)
  - [low_light](sample_panels/low_light_breakfast_box_000.png)

## UniVAD Progress

### Completed

- official repo cloned under [external/UniVAD](../../../../external/UniVAD)
- MVTec LOCO formatted root prepared under [data/mvtec_loco_caption](../../../../data/mvtec_loco_caption)
- smoke subset prepared under [data/mvtec_loco_caption_smoke](../../../../data/mvtec_loco_caption_smoke)
...
- smoke grounding masks generated for:
  - [train/good/000](../../../../external/UniVAD/masks/mvtec_loco_caption_smoke/breakfast_box/train/good/000/grounding_mask.png)
  - [test/good/000](../../../../external/UniVAD/masks/mvtec_loco_caption_smoke/breakfast_box/test/good/000/grounding_mask.png)
  - [test/logical_anomalies/000](../../../../external/UniVAD/masks/mvtec_loco_caption_smoke/breakfast_box/test/logical_anomalies/000/grounding_mask.png)

### Local Patches Applied

- [external/UniVAD/test_univad.py](../../../../external/UniVAD/test_univad.py)
  - `--max_samples` support
  - CPU-safe dataloader config
  - `data_path`-based train sample resolution
- [external/UniVAD/UniVAD.py](../../../../external/UniVAD/UniVAD.py)
  - CPU-safe device propagation
  - local CLIP cache path
- [external/UniVAD/modules.py](../../../../external/UniVAD/modules.py)
  - CPU-safe DINO featurizer placement
- [external/UniVAD/models/component_segmentaion.py](../../../../external/UniVAD/models/component_segmentaion.py)
  - `.cuda()` removal for CPU path
  - `MeanShift(n_jobs=1)`
- [external/UniVAD/utils/crf.py](../../../../external/UniVAD/utils/crf.py)
  - `pydensecrf` fallback
- [external/UniVAD/models/GroundingDINO/groundingdino/util/get_tokenlizer.py](../../../../external/UniVAD/models/GroundingDINO/groundingdino/util/get_tokenlizer.py)
  - local BERT path resolution

### Current Status

- smoke run log: [log.txt](univad_smoke/mvtec_loco/log.txt)
