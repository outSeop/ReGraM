...
PROFILES: dict[str, list[SyncItem]] = {
    "notebook_assets": [
        ...
        SyncItem("experiments/validation/condition_shift_baseline/contracts.py", "file"),
        SyncItem("experiments/validation/condition_shift_baseline/prepare_univad_mvtec_loco.py", "file"),
        SyncItem("experiments/validation/condition_shift_baseline/prepare_univad_smoke_subset.py", "file"),
        SyncItem("experiments/validation/condition_shift_baseline/run_univad_smoke_colab.py", "file"),
        SyncItem("experiments/validation/condition_shift_baseline/run_univad_clean_eval.py", "file"),
        SyncItem("experiments/validation/condition_shift_baseline/run_patchcore_manifest_shift.py", "file"),
        SyncItem("experiments/validation/condition_shift_baseline/augmentation_runtime.py", "file"),
    ],
    "patchcore_results": [
